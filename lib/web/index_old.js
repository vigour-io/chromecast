...
function vigourChromeCastWeb (appId) {
  APP_ID = appId
...
vigourChromeCastWeb.prototype.stopVideo = function () {
  currentMediaSession.stop()
}

vigourChromeCastWeb.prototype.stopSession = function () {
  if (session) {
    session.stop()
  }
}

vigourChromeCastWeb.prototype.castApp = function (media) {
...
module.exports = vigourChromeCastWeb
